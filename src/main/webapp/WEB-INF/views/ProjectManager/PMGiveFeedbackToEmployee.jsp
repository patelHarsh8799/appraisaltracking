						...
						<div class="card-body">
							...
							<form action="savefeedback" method="post">
								<div class="row mb-6" style="margin-bottom: 20px!important;">
									<div class="col-sm-12">
										<textarea class="form-control" name="feedbackText" rows="4" placeholder="Write your feedback here..."></textarea>
									</div>
								</div>
								...
								<div class="row mb-3">
									<div class="col-sm-12">
										<div class="row mb-3"
											...
											<label class="col-sm-4 col-form-label">Feedback To: </label>
											<div class="col-sm-8">
								...
								<div class="row mb-3">
									<div class="col-sm-12">
										<div class="row mb-3"
											style="margin-top: 1rem; margin-bottom: 0 !important;">
											<label class="col-sm-4 col-form-label">From Appraisal: </label>
											<div class="col-sm-8">
								...
								<div class="row mb-3">
									<div class="col-sm-12">
										<div class="row mb-3"
											style="margin-top: 1rem; margin-bottom: 0 !important;">
											<label class="col-sm-4 col-form-label">Feedback Given By: </label>
											<div class="col-sm-8">
