		...
		<section class="section">
			<div class="row">
				<div class="col-lg-6">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">Fill Appraisal Form</h5>
							<form class="row g-3" action="saveappraisal" method="post"
								enctype="multipart/form-data">
								<div class="col-md-12">
									<label for="appraisalCycle" class="form-label">Appraisal
										Cycle (Quarter)(Year):</label> <input type="text" class="form-control"
